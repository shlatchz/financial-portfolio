...
import { PortfolioSummary, RebalanceRecommendation, PortfolioAnalyzer, formatCurrency, CustomSecurity } from '@portfolio/core';
        ...
        {summary.customSecurities.length > 0 && (
          <Alert severity="info" sx={{ mb: 2 }}>
            <Typography variant="body2">
              ...
              {formatCurrency(summary.customSecurities.reduce((sum: number, cs: CustomSecurity) => sum + cs.value, 0))}) 
        ...
        {summary.customSecurities.length > 0 && (
          <Box sx={{ mb: 3 }}>
            ...
            <Alert severity="info" sx={{ '& .MuiAlert-message': { flexGrow: 1 } }}>
              ...
              <Box sx={{ mt: 1 }}>
                {summary.customSecurities.map((cs: CustomSecurity) => (
                  <Typography 
                    key={cs.id} 
                    variant="body2" 
                    sx={{ 
