...
import { PortfolioSummary, formatCurrency, CustomSecurity } from '@portfolio/core';
...
const PortfolioSummaryCards: React.FC<PortfolioSummaryCardsProps> = ({ summary }) => {
  ...
  const customSecuritiesTotal = summary.customSecurities.reduce((sum: number, cs: CustomSecurity) => sum + cs.value, 0);
